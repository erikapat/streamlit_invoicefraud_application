...
if uploaded_file is not None:
    try:
        ...
        if missing_columns:
            ...
            # Cálculo del riesgo (de 0 a 100)
            if total_validations > 0:
                risk_score = int((failed_count / total_validations) * 100)
            else:
                risk_score = 0
            ...
            with col1:
                ...
                st.markdown(f"<h4>🛑 Nivel de riesgo de la factura: <b>{risk_score}/100</b></h4>", unsafe_allow_html=True)
